/**
 * SVG icons for common identity providers.
 * These match the icons used in Keycloak's default login theme.
 */

export interface ProviderIconProps {
  /** The provider type (e.g., google, github, facebook) */
  providerId: string;
  /** Optional CSS classes for custom icons */
  iconClasses?: string;
}

/**
 * Renders an icon for a given identity provider.
 * Falls back to a generic icon if the provider is not recognized.
 */
export function ProviderIcon({ providerId, iconClasses }: ProviderIconProps) {
  // If custom icon classes are provided, use those
  if (iconClasses) {
    return <span className={iconClasses} aria-hidden="true" />;
  }

  // Otherwise, use built-in SVG icons
...
function MicrosoftIcon() {
  return (
    <svg viewBox="0 0 448 512" aria-hidden="true">
      <path fill="#F25022" d="M0 32h214.6v214.6H0V32z" />
      <path fill="#7FBA00" d="M233.4 32H448v214.6H233.4V32z" />
      <path fill="#00A4EF" d="M0 265.4h214.6V480H0V265.4z" />
      <path fill="#FFB900" d="M233.4 265.4H448V480H233.4V265.4z" />
    </svg>
  );
}
...
function TwitterIcon() {
  return (
    <svg viewBox="0 0 1200 1227" fill="none" aria-hidden="true">
      <path
